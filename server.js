...
app.use(express.urlencoded({ extended: true, limit: '999mb' })); // Adjust the limit as needed
app.use(express.json({ limit: '999mb' })); // Adjust the limit as needed
    ...
    if (err) {
      ...
      fs.readdir('premium', (err, pstockFiles) => {
        if (err) {
          ...
          <html>
          <head>
          <title>Star Generator's Dashboard</title>
              ...
              <ul>
                  <li>
                      <a href="#">
                          ...
                          <span class="title">Star Gen Dashboard</span>
                      </a>
                  </li>
...
<div class="floating-heart">
    ...
    <div class="tooltip">Made with ❤️ By Zammy!!</div>
    </div>
...
app.get('/help', requireLogin, (req, res) => {
  ...
  <head>
  <title>Star Gen Dashboard -help</title>
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css">
    <link rel="icon" href="https://cdn.discordapp.com/attachments/1152538414017687684/1154710899525947422/gift.jpg" type="image/jpg">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/ionicons@6.0.1/dist/css/ionicons.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
      ...
      <ul>
          ...
          <li>
              <a href="/edit">
                  ...
                  <span class="title">Star Generator's Dashboard</span>
              </a>
          </li>
      ...
      <ul>
          ...
          <li>
              <a href="/edit">
                  ...
                  <span class="title">Star Gen's Dashboard</span>
              </a>
          </li>
...
app.use(bodyParser.json({ limit: '999mb' })); // Adjust the limit as needed
app.use(bodyParser.urlencoded({ extended: true, limit: '999mb' })); // Adjust the limit as needed
